...
/*-*-*-*-*-*-*-*-*--*-*-*-*-*-*/
/*-*-*-*-*- MACROS -*-*-*-*-*-*/
#define I2C_CLR_TWINT			(TWCR_R |= (1<<I2C_TWCR_TWINT))

#define I2C_ENABLE				(TWCR_R |= (1<<I2C_TWCR_TWEN))
#define I2C_SET_START_BIT		(TWCR_R |= (1<<I2C_TWCR_TWSTA))
#define I2C_SET_STOP_BIT		(TWCR_R |= (1<<I2C_TWCR_TWSTO))
#define I2C_SET_ACK_BIT			(TWCR_R |= (1<<I2C_TWCR_TWEA))

#define I2C_TWBR_VALUE()		(uint8_t)(((F_OSC/I2C_SCL_CLK)-16)/(2*PRESCALER_VALUE))
#define I2C_WAIT_TWINT()		((TWCR_R & (1<<I2C_TWCR_TWINT)) == 0)
#define I2C_readSTATUS()		((TWSR_R) & (0xF8))
#define I2C_START_ENABLE_FLAG	(TWCR_R = (1<<I2C_TWCR_TWSTA)|(1<<I2C_TWCR_TWEN)|(1<<I2C_TWCR_TWINT))
#define I2C_STOP_ENABLE_FLAG	(TWCR_R = (1<<I2C_TWCR_TWSTO)|(1<<I2C_TWCR_TWEN)|(1<<I2C_TWCR_TWINT))
#define I2C_ENABLE_FLAG			(TWCR_R = (1<<I2C_TWCR_TWEN)|(1<<I2C_TWCR_TWINT))
#define I2C_ENABLE_FLAG_ACK		(TWCR_R = (1<<I2C_TWCR_TWEN)|(1<<I2C_TWCR_TWINT)|(1<<I2C_TWCR_TWEA))
