...
static Std_ReturnType WrlsCom_initializeMemoryBlocks(void)
{
	...
	WrlsCom_ConnectedDeviceMAC.Address_Offset = WRLS_COM_CONNECTED_DEVICE_MAC_LOC;
	WrlsCom_ConnectedDeviceMAC.Data_Size = WRLS_COM_CONNECTED_DEVICE_MAC_SIZE;
	/* Device Name Block */
	WrlsCom_ConnectedDeviceName.Address_Offset = WRLS_COM_CONNECTED_DEVICE_NAME_LOC;
	WrlsCom_ConnectedDeviceName.Data_Size = WRLS_COM_CONNECTED_DEVICE_NAME_SIZE;
	/* Block to indicate if there is a connected device saved */
	WrlsCom_ValidDevFlag.Address_Offset = WRLS_COM_VALID_DEVICE_FLAG_LOC;
	WrlsCom_ValidDevFlag.Data_Size = 1;
