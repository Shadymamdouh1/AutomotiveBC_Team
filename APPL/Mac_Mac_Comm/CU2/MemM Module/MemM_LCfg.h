...
#define MEMM_USED_BLOCKS_NUM				5U
...
#define MEMM_CONNECTED_PROG_PASSWORD_ID			4U
#define MEMM_CONNECTED_PROG_PASSWORD_LOC		0x40U
#define MEMM_CONNECTED_PROG_PASSWORD_SIZE		6U
