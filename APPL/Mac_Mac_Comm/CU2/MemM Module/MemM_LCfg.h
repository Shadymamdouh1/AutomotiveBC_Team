...
#define MEMM_USED_BLOCKS_NUM				3U
...
#define MEMM_CONNECTED_DEVICE_MAC_ID		3U
#define MEMM_CONNECTED_DEVICE_MAC_LOC		0x02U
#define MEMM_CONNECTED_DEVICE_MAC_SIZE		23U
