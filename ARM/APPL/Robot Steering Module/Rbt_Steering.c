...
/**************************************************************************************/
	...
	if(Motor_init() == MOTOR_STATUS_ERROR_NOK)
	{
		return E_NOT_OK;
	}
